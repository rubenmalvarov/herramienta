...
<html lang="es">
<head>
    <title>NukeTrack Eliminar Usuarios</title>
    <meta charset="UTF-8">
...
<body>
		...
		//	echo $apellido1;
			...
			//echo $id;
            		$eliminar="DELETE FROM tfg.usuarios WHERE idusuario=$id";
			$resultado1 = mysqli_query( $conexion, $eliminar ) or die ("Algo ha ido mal en la eliminacion del usuario");
